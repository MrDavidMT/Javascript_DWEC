 ...
 *  The treasure is a cell whose value is the same as its coordinates. Your program must first read in the treasure map data into a 5 by 
 * 5 array. Your program should output the cells it visits during its search, and a message indicating where you found the treasure.
 */
...
var pasos=[];
do{
    valor=matriz[parseInt(valor.charAt(0))-1][parseInt(valor.charAt(1))-1];
    pasos.push(valor);
}while(valor!=matriz[parseInt(valor.charAt(0))-1][parseInt(valor.charAt(1))-1]);
console.log(...pasos);
